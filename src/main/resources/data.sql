...
--NAMELESS
insert into marca(name,pais,pais_api,descripcion,imagen) values('Nameless','Alemania','Germany','Tabaco rubio','https://i.ibb.co/Jys8s36/nameless.png');
...
--Tangiers
insert into marca(name,pais,pais_api,descripcion,imagen) values('Tangiers','USA','usa','Tabaco negro','https://i.ibb.co/LPWDd6j/tangiers.png');
...
--Serbetli
insert into marca(name,pais,pais_api,descripcion,imagen) values('Serbetli','Alemania','Germany','Tabaco rubio premium','https://i.ibb.co/cTzSKqY/serbetli.png');
...
--Revoshi
insert into marca(name,pais,pais_api,descripcion,imagen) values('Revoshi','Turquia','Turkey','Tabaco rubio','https://i.ibb.co/b69zGrb/revoshi.png');
...
--Darkside
insert into marca(name,pais,pais_api,descripcion,imagen) values('Darkside','Rusia','Russian','Tabaco negro','https://i.ibb.co/1TpbsMG/darkside.png');
...
--Dozaj
insert into marca(name,pais,pais_api,descripcion,imagen) values('Dozaj','Turquia','Turkey','Tabaco rubio','https://i.ibb.co/ZBmV6nP/dozaj.png');
...
insert into tabaco (name,name_api,descripcion,marca) values('Zenter Schox','El sabor más agrio del mundo a partir de aromas de lima y limón. Es tan agrio que te volverá loco. ','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Zenter Schox');
insert into tabaco (name,name_api,descripcion,marca) values('Laoz','Jugo dulce de cereza, afrutado e intenso combinado con arándanos. Añadimos mentol para hacerlo más fresco. Sabor afrutado y fresco. ','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Laoz');
insert into tabaco (name,name_api,descripcion,marca) values('Original Vanta Zotic','Batido afrutado de maracuyá, durazno y zumo de naranja, recuerda a un limonada muy famosa con un toque exótico.','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Original Vanta Zotic');
insert into tabaco (name,name_api,descripcion,marca) values('Cotton Candy Craem','Algodón de azúcar, sandía, mango y arándanos.','Hookain');
...
insert into tabaco (name,name_api,descripcion,marca) values('Orogina','Naranja y mandarina combinadas con un toque de White Caek.','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Orogina');
insert into tabaco (name,name_api,descripcion,marca) values('Eyez Kalt','Muy frío. Caramelo de menta refinado con plátano y lima.','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Eyez Kalt');
insert into tabaco (name,name_api,descripcion,marca) values('Vantanaz','El fuerte sabor a piña se mezcla con una combinación de mango, pomelo y zumo de durazno. Idéntico a Vanta Piña.','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Vantanaz');
insert into tabaco (name,name_api,descripcion,marca) values('Pic Zkittlez','Refrescante té helado de melocotón salvaje y albaricoque. Mezclado con menta y unos ingredientes especiales que no te contamos.','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Pic Zkittlez');
insert into tabaco (name,name_api,descripcion,marca) values('Ch3ri Zkittlez','Sabor intenso a cereza y fruta de dragón. Mejor de lo que te puedas imaginar.','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Ch3ri Zkittlez');
insert into tabaco (name,name_api,descripcion,marca) values('Sm!nt','Experimenta el sabor refrescante de nuestro caramelo de menta a la tic tac. Fresco y dulce.','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Sm!nt');
insert into tabaco (name,name_api,descripcion,marca) values('Fellatio','Batido de sandía, melón dulce, maracuyá y frutas el bosque.','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Fellatio');
insert into tabaco (name,name_api,descripcion,marca) values('Green Lean','La mejor lima que jamás hayas probado, convertida en zumo de lima. Siente el sabor y el frescor de miles de limas que explotarán en tu cazoleta.','Hookain');
...
insert into tabaco (name,name_api,descripcion,marca) values('Kaffa Yayo','El mejor postre con sabor a coco. Coco de Hawai cubierto por una fina crema de almendras con vainilla bourbon.','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Kaffa Yayo');
insert into tabaco (name,name_api,descripcion,marca) values('Bubblenciaga','El típico chicle americano en su momento de mayor sabor. Dulce y duradero hasta dejarte boquiabierto.','Hookain');
...
insert into tabaco (name,name_api,descripcion,marca) values('Cactopus','Dulce y cremoso al mismo tiempo. El sabor dulce a cactus con la fresa y vainilla hacen un trio delicioso e intenso. ','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Cactopus');
insert into tabaco (name,name_api,descripcion,marca) values('Lemenciaga','Un sabor refrescante de limón y esencia de té verde con el indispensable toque de menta fresca.','Hookain');
...
insert into tabaco (name,name_api,descripcion,marca) values('Punani','Jugoso, jugosísimo, mango y maracuyá fusionado con naranja y piña.','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Punani');
insert into tabaco (name,name_api,descripcion,marca) values('White Caek','El más sabroso! tarta de queso con un toque de caramelo.','Hookain');
...
insert into tabaco (name,name_api,descripcion,marca) values('Big Black Barries','Intenso sabor a uva moscatel con esencia de mentol..','Hookain');
...
insert into tabaco (name,name_api,descripcion,marca) values('Soleiro Spliff','Una explosión de sabores. Marakuyá, caramelo de naranja y helado de vainilla. ','Hookain');
insert into formato(gramos,precio,tabaco) values(50.0,3.95,'Soleiro Spliff');
insert into tabaco (name,name_api,descripcion,marca) values('Kivi King','Kiwi afrutado intenso sobre una cama de lima. Agradablemente fresco con un toque de menta y mentol.','Hookain');
